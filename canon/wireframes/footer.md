...
- The colophon states how the page was made. It says the page itself was built with coding agents, which states the author's working method on the one artifact the reader is already inside rather than describing it elsewhere.
