...
Eric needs a single canonical landing page at erclx.dev that introduces him and his work to recruiters, collaborators, and curious visitors. Linkedin, Github, and a PDF resume already exist, but none of them tell the story in one place under his own domain.

## Goals

- Visitors arriving from search, a Github profile, or a Linkedin link get a coherent summary of who Eric is and what he ships in one scroll
...
- Content is downstream of the parent career repo. After v1, page copy lands via `.claude/SYNC-QUEUE.md` and is never edited in place here.
