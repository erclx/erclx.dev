...
- The name and the toggle both leave this surface as the reader scrolls, carried into the sticky bar. See `canon/wireframes/site-bar.md` for what they land in and `canon/context/theming.md` for why exactly one toggle exists.
