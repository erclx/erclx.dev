...
Whether the 56-image review-capture set the sections above describe should move under the same `evidence/` shape wholesale is a separate, open question, scoped to `.canon/tasks/v09.8-pr-visual-evidence.md` rather than to this one.
