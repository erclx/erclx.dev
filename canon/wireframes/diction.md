...
Distinct from the chart treatment below, and deliberately so. A chart is drawn on paper and wants a light plate and a magnifier. A screenshot is a picture of this app and keeps the page's own dark card. See `canon/context/case-study-figures.md` for the chart dialog, which is a separate mechanism.
