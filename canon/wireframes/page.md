...
The two are not separate treatments meeting at a seam. The header's band fades into the page over its last stretch rather than ending on a line, and what continues underneath is the same surface. See `canon/context/shader-field.md` and `canon/context/page-ground.md`.
...
- The section rail sits left, from 1280px, and states position. See `canon/wireframes/section-nav.md`.
- The contact dock sits right, at every width, and offers reach. See `canon/wireframes/contact-dock.md`.

The split is deliberate. One tells the reader where they are and the other gives them somewhere to go, which is the division `canon/REQUIREMENTS.md` § Navigation draws.
